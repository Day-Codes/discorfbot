...
module.exports = {
  ...
  /**
    ...
    if(!interaction.member.permissions.has("KICK_MEMBERS")) return interaction.followUp(`<:Denied:930607627027759145> **You can't use this command!**`)
    ...
    const memberPosition = user.roles.highest.rawPosition;
      ...
      if (user.id === interaction.member.id) return interaction.followUp({
            content: `<:Denied:930607627027759145> **You can't kick yourself!**`
        });
      ...
      if (user.id === interaction.guild.ownerId) return interaction.followUp({
            content: `<:Denied:930607627027759145> **You cannot kick the Server Owner!**`
        });
